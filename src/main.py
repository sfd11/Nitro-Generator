...
░▒██▓██ ░▄█ ▒▒██░  ██▒░░  █   ░
 ...
 ░▓ ░ ▒▓ ░▒▓░░ ▒░▒░▒░ ▒▒ ░ ░▓ ░
  ...
  ░    ░         ░ ░   ░    ░""")
    time.sleep(2)
    print("Nitro link Generator")
    time.sleep(0.3)
    print("Send Discord dm in case of questions\n")
    time.sleep(0.2)
    ...
    print(f"Valid codes are saved to Valid Codes.txt")
    print(f"Invalid codes are saved to Invalid Codes.txt")

    input("\nSuccesfully generated codes. press enter to close.")
